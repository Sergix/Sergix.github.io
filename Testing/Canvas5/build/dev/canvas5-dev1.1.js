...
/*
* Game Engine dev1.1 Original Full Script
* (c) 2016 Sergix
*/

console.info("Canvas5 JavaScript Engine; version dev1.1; (c) 2016 Sergix");
...
function Sprite(image=null) {
    ...
    this.onKeyDown = function (evt) {
        switch (evt.keyCode) {
            ...
            case 32: /*space*/this.spacePressed = true; break;
        }
    };
    ...
    this.onKeyUp = function (evt) {
        switch (evt.keyCode) {
            ...
            case 32: /*space*/this.spacePressed = false; break;
        }
    };
